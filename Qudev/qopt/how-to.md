...
Note that for high-frequency or fast-switching laser (nanosecond) settings, it is better to use the digital modulation port to for a cleaner laser pulse shape (with less distortion and ringing).
