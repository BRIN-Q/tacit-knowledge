...
Lowering an object’s temperature down to 1 Kelvin (or even milli-Kelvin temperatures, for that matter) is like launching a rocket into space: it is a multi-step process in which each stage reaches a certain height and requires a different engine to operate. Here, we provide a hitchhiker’s guide to cooling a sample down to 1.5 Kelvin from room temperature, learning how to safely energize a superconducting magnet, and operating the temperature controller and measurement instruments to interrogate your sample, such as measuring its electrical conductivity.

Prior knowledge of thermodynamics, usually taught in the second year, is very useful for understanding how the cooling process works!

![Cryostat perspective view](../assets/TeslatronPTPlus.png)  
*Figure 1. 1.6 K Variable Temperature Insert Perspective View*

### Lowering The Cryostat's Temperature
