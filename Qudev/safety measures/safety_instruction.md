# 2026 Safety Training Instructions - Direct Version
Created by: Adha Sukma Aji

## Mandatory Safety Guide

This guide restates the safety training content as direct rules.
Follow these rules every time.
Do not treat them as suggestions.

Dangerous chemicals, compressed gases, and cryogenic liquids can injure or kill people quickly.
You must understand the reason behind each rule before you work.
...
- Store cylinders below 40 C.
- Store cylinders in a well-ventilated area.
- Move cylinders slowly and deliberately.
- Use correct cylinder carts and supports.
...
Flammable gases include H2, CH4, C2H2, and similar gases.

- Use flammable gas only with proper ventilation and exhaust.
- Keep ignition sources away.
- Check for leaks before operation.
- Stop work immediately if you smell gas or suspect a leak.
- Consider gas density before starting work.
- Prevent gas from collecting near floors, ceilings, corners, or closed spaces.
...
Oxidizing gases include O2 and similar gases.

- Treat oxygen as a combustion accelerator.
- Keep oil, grease, solvents, and flammable materials away from oxygen equipment.
...
Toxic gases include CO and similar gases.

- Treat any toxic gas leak as life-threatening.
- Evacuate first.
- Use the correct gas mask only if trained and safe to do so.
- Confirm the gas type before choosing a mask.
...
Inert gases include N2, Ar, and similar gases.

- Use inert gases in ventilated areas.
- Treat large releases as oxygen-deficiency hazards.
...
- Keep skin away from liquid nitrogen and cold metal.
...
Cylinder replacement is a high-risk task.
...
- Inspect the valve.
- Inspect the tubing and fittings.
- Confirm the gas name.
- Confirm the gas hazard.
...
- Secure the cylinder at two points.
- Connect fittings correctly.
- Tighten fittings properly.
- Open valves slowly.
- Keep your body away from the pressure path.
...
- Perform a leak check every time.
- Use Snoop solution.
- Check each fitting.
- Check each valve connection.
- Check the regulator connection.
...
- Contact the chemical management team before gas runs low.
- Order high-purity N2 about 3 weeks early.
- Order high-purity O2 about 3 weeks early.
...
Gas alarms require immediate action.
Do not debate the alarm.
Do not delay evacuation.

### 4.1 If the Alarm Sounds in Your Work Area

1. Evacuate first.
2. Close the main valve only if you can do it quickly and safely.
3. Turn on exhaust only if you can do it quickly and safely.
4. Identify the abnormal gas type after you are safe.
...
1. Check whether people are inside.
2. Do not enter alone.
3. Identify the abnormal gas type.
4. Respond according to the gas type only if safe.
5. Use the designated chlorine gas mask when appropriate.
6. Activate exhaust for oxygen deficiency when safe.
7. Contact the designated supervisor.
8. Contact site emergency or security staff.
...
Liquid nitrogen requires training, PPE, and careful movement.
Do not treat it like cold water.
...
- Use liquid nitrogen only with ventilation.
- Keep containers vented.
...
- Use cryogenic-compatible materials.
...
- Receive training before first use.
- Work in a ventilated area.
- Wear leather gloves.
- Wear safety glasses or face protection.
- Pre-cool equipment gradually during first filling.
- Watch frost formation.
- Keep skin away from cold gas and cold surfaces.
- Do not use cotton gloves.
...
- Use metal liquid nitrogen containers only.
- Do not use glass Dewar flasks for routine handling.
- Keep the container upright.
- Keep the container on a level surface.
- Keep the container away from heat.
- Protect the container head.
...
- Use the attached cap on vented containers.
- For sealed containers, close the pressure valve.
...
- Open the withdrawal valve slowly.
- Start with the smallest opening.
- Let cold gas cool the receiving container.
...
- Install a backflow prevention valve at the container outlet.
...
- Do not ride with liquid nitrogen in an elevator.
- Put the container in the elevator without people.
...
- For minor injury, apply zinc oxide ointment or Vaseline.
- Use the nearest designated first aid kit.
- For severe injury, warm gradually with cold water.
...
Chemical work requires hazard knowledge before action.
Do not open, pour, heat, mix, or transport chemicals without understanding the risk.

### 6.1 Organic Solvents

Organic solvents include acetone, methanol, trichloroethylene, xylene, and similar solvents.
...
- Store every liquid chemical in the drawer.
- Keep only ethanol on the working desk.
- Return all other liquid chemicals to the drawer immediately after use.
- Secure liquid chemicals upright in the drawer.
...
- Treat acetone as a Class 1 petroleum product.
- Treat acetone like gasoline near heat and sparks.
- Keep acetone away from hot plates.
- Keep acetone away from hot plate areas.
- Keep acetone away from electrical switches.
...
- Treat isopropanol alcohol as a flammable solvent.
- Keep isopropanol alcohol away from hot plates.
- Keep isopropanol alcohol away from flames, sparks, and electrical ignition sources.
- Use isopropanol alcohol only with ventilation.
- Close the bottle immediately after use.
- Store isopropanol alcohol in the drawer after use.
...
- Treat toluene as a flammable and toxic solvent.
- Use toluene only in a ventilated area or appropriate hood.
- Avoid inhalation.
- Avoid skin contact.
- Keep toluene away from hot plates, flames, sparks, and electrical ignition sources.
- Close the bottle immediately after use.
- Store toluene in the drawer after use.
...
- Keep strong acids away from skin and eyes.
- Keep strong alkalis away from skin and eyes.
- Wear proper gloves and eye protection.
- Work in the correct hood.
...
- Treat hydrofluoric acid as extremely dangerous.
- Wear protective gloves.
- Wear a face shield.
- Use the blue specialized gloves.
- Know the HF ointment location before starting.
- Use the topical ointment from the designated HF emergency kit or chemical first-aid station.
...
- Treat concentrated sulfuric acid as water-reactive.
- Do not add water to sulfuric acid.
...
- Keep oxidizing materials away from reducing materials.
- Keep strong acids away from acetone.
- Keep strong acids away from alcohols.
- Keep strong acids away from metals.
...
- Use sanitation gloves only for hygiene.
- Do not use sanitation gloves as chemical protection.
- Use blue specialized gloves for hydrofluoric acid.
- Use heat-resistant gloves for hot or cold contact.
- Use nitrile gloves with caution around organic solvents.
...
- Return bottles to the original location immediately after pouring.
- Close caps immediately.
- Store liquid chemical bottles in the drawer.
- Leave only ethanol on the working desk.
- Put every other liquid chemical back in the drawer after use.
- Use a carrying case when transporting bottles between work areas or controlled areas.
...
- Read the SDS or MSDS before using unfamiliar chemicals.
- Check the hazards.
...
CVD work for TMDCs uses sulfur and selenium.
Treat this work as toxic and electrically hazardous.
Do not enter the CVD area unless the work requires it.

### 8.1 Toxic Vapor Risk

- Treat sulfur and selenium CVD as toxic work.
- Limit continuous time in the CVD area to 30 minutes.
- Leave the CVD area after 30 minutes.
...
- Treat CVD equipment as a high-current electrical hazard.
- Wear thick-soled shoes.
- Keep your feet dry.
- Keep the floor area dry.
...
- Check the CVD area with the remote camera before entering.
- Confirm whether entry is necessary.
...
Electrical measurement apparatus may use voltage above 200 V.
Treat this voltage as lethal.
Do not treat measurement wiring as low-risk equipment.

### 9.1 High Voltage Risk

- Treat voltage above 200 V as a lethal hazard.
- Confirm the voltage range before measurement.
- Keep hands away from energized terminals.
- Keep the area dry.
...
- Clear chemicals at least 2 m away from the apparatus.
- Keep acetone away from the apparatus.
- Keep isopropanol alcohol away from the apparatus.
...
- Never leave electrical wire exposed.
- Stop the measurement immediately if a wire is exposed.
- Pull the plug from the electrical outlet if it is safe to do so.
- De-energize the apparatus before touching the wire.
- Shield the exposed wire with electrical tape only after power is removed.
- Report damaged wiring.
...
- Use an acrylic plate only as a temporary physical barrier.
- Use acrylic plate thickness above 5 mm.
- Place the acrylic plate between people and the hazard.
...
- Do not wear wool sweaters during electrical measurement.
- Do not wear fabric that sheds fibers easily.
...
Do this check before starting dangerous work.

- You know the chemical or gas name.
- You know the hazard class.
- You know the emergency response.
- You know the PPE.
- You know the ventilation requirement.
- You know the spill response.
- You know the waste route.
- You know the nearest exit.
- You know who to contact.
- The hood or exhaust is working.
- The container is stable.
- The label is clear.
- The work area is clean.
- Electrical wires are insulated and undamaged.
...
Why: Most preventable accidents begin before the experiment starts. A short check prevents rushed decisions during danger.

---

**Document prepared for 2026 Safety Training**
