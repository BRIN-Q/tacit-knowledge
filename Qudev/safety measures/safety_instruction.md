...
Please follow all instructions carefully, not only to protect yourself and others, but also to protect the instruments from becoming very expensive modern art.

## Mandatory Safety Guide
1. This guide restates the safety training content as direct rules.
2. Follow these rules every time.
3. Do not treat them as suggestions.
4. Dangerous chemicals, compressed gases, and cryogenic liquids can injure or kill people quickly.
5. You must understand the reason behind each rule before you work.
...
8.	Check whether people are inside.
9.	Do not enter alone.
10.	Identify the abnormal gas type.
11.	Respond according to the gas type only if safe.
12.	Use the designated chlorine gas mask when appropriate.
